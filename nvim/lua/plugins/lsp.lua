return {
	...
	},
	{
		...
		config = function()
			local map_lsp_keybinds = require("nsyout.keymaps").map_lsp_keybinds
			...
			-- Blink provides completion capabilities that we merge into the client.
			local capabilities = vim.lsp.protocol.make_client_capabilities()
			-- Use Blink capabilities when available.
